...
import meta from "@/data/pages/privacy-policy/meta.json";
import hero from "@/data/pages/privacy-policy/hero.json";
import content from "@/data/pages/privacy-policy/content.json";
